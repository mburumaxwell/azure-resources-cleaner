...
namespace AzureCleaner.Tests;

public class AzureResourceCleanerTests(ITestOutputHelper outputHelper)
{
    [Fact]
    ...
    private (AzureResourceCleaner, ModifiedAzureResourcesPurger, ModifiedDevOpsPurger) CreateCleaner(IList<string> projects)
    {
